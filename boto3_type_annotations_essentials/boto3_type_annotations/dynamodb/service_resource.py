...
class Table(base.ServiceResource):
    attribute_definitions = None  # type: List
    table_name = None  # type: str
    key_schema = None  # type: List
    table_status = None  # type: str
    creation_date_time = None  # type: datetime
    provisioned_throughput = None  # type: Dict
    table_size_bytes = None  # type: int
    item_count = None  # type: int
    table_arn = None  # type: str
    table_id = None  # type: str
    billing_mode_summary = None  # type: Dict
    local_secondary_indexes = None  # type: List
    global_secondary_indexes = None  # type: List
    stream_specification = None  # type: Dict
    latest_stream_label = None  # type: str
    latest_stream_arn = None  # type: str
    restore_summary = None  # type: Dict
    sse_description = None  # type: Dict
    name = None  # type: str

    def batch_writer(
        self,
        overwrite_by_pkeys=None,  # type: Optional[List[str]]
    ):
        # type: (...) -> None
        """
